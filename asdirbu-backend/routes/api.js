...
router.post('/user/timesheet/startdate',userCtrl.getTimeSheetByStartDate);
router.post('/user/timesheet',userCtrl.getUserTimesheet);
router.post('/addcustomtime',userCtrl.addCustomTime);
router.post('/userchatstatus',userCtrl.changeUserChatStatus);
...
router.post('/opayPayment',jwtAuth.verifyToken,bookingCtrl.opayPayment);
router.post('/changePaymentStatus',bookingCtrl.changePaymentStatus);
...
router.post('/getjobreviewbyid', userCtrl.getJobReviewById);
router.get('/countmessage',jwtAuth.verifyToken, chatCtrl.countMessage);
